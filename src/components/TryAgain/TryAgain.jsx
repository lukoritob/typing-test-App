    ...
    return (
        <div className="try-again-container">
            ...
            <div>
                ...
                <button onClick={() => {
                    window.open("https://www.facebook.com/sharer/sharer.php?u=https://github.com/lukoritob",
                        "facebook-share-dialog",
                        "width=800, height=600")
                }} className='end-buttons share-btn'>Share</button>
                <button onClick={() => {
                    window.open("https://twitter.com/intent/tweet?text=https://github.com/lukoritob",
                        "Twitter",
                        "width=800, height=600")
